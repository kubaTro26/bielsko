...
function wp_insert_user( $userdata ) {
	...
	$kod = empty( $userdata['kod'] ) ? '' : $userdata['kod'];
	$firma = empty( $userdata['firma'] ) ? '' : $userdata['firma'];
	...
	$new_user_email  = empty( $userdata['new_user_email'] ) ? '' : $userdata['new_user_email'];
	//dumping
	...
	//dumping
	$compacted = compact( 'user_pass', 'user_nicename', 'user_email', 'user_url', 'user_registered', 'user_activation_key', 'display_name','nip','telefon','wojewodztwo','kod','firma', 'city','second_address_line','first_address_line','new_user_email' );
	...
	/**
	 * Filters user data before the record is created or updated.f
	 *
