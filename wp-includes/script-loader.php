...
function wp_default_scripts( $scripts ) {
	...
	$scripts->add( 'jquery-core', "/wp-includes/js/jquery/jquery.js", array(), false );
	$scripts->add( 'jquery-migrate', "/wp-includes/js/jquery/jquery-migrate.js", array(), false );
	...
	$scripts->add( 'wp-util', "/wp-includes/js/wp-util.js", array( 'underscore', 'jquery' ), false, 1 );
	did_action( 'init' ) && $scripts->localize(
		'wp-util',
		'_wpUtilSettings',
		array(
