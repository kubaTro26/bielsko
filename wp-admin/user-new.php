...
<form method="post" name="createuser" id="createuser" class="validate" novalidate="novalidate"
	...
	add_action( 'user_new_form_tag', 'my_plugin_assets' );
	function my_plugin_assets() {
		...
		wp_register_script( 'custom', home_url() . '/wp-admin/custom.js' );
...
<input name="action" type="hidden" value="createuser" />
	...
	$telefon        = $creating && isset( $_POST['telefon'] ) ? wp_unslash( $_POST['telefon'] ) : '';
	
	$wojewodztwo        = $creating && isset( $_POST['wojewodztwo'] ) ? wp_unslash( $_POST['wojewodztwo'] ) : '';
	$kod        = $creating && isset( $_POST['kod'] ) ? wp_unslash( $_POST['kod'] ) : '';
	$firma        = $creating && isset( $_POST['firma'] ) ? wp_unslash( $_POST['firma'] ) : '';
	$city        = $creating && isset( $_POST['city'] ) ? wp_unslash( $_POST['city'] ) : '';
	$second_address_line        = $creating && isset( $_POST['second_address_line'] ) ? wp_unslash( $_POST['second_address_line'] ) : '';
	$first_address_line         = $creating && isset( $_POST['first_address_line'] ) ? wp_unslash( $_POST['first_address_line'] ) : '';
	
	$nip         = $creating && isset( $_POST['nip'] ) ? wp_unslash( $_POST['nip'] ) : '';
...
<table class="form-table" role="presentation">
	...
	<tr class="form-field form-required">
		<th scope="row"><label for="user_login">NIP <span class="description"><?php _e( '(required)' ); ?></span></label></th>
		<td><input name="nip" type="text" id="nip" value="<?php echo esc_attr( $nip ); ?>" aria-required="true" autocapitalize="none" autocorrect="off" autocomplete="off" maxlength="60" /></td>
	</tr>
	<tr class="form-field form-required">
	...
	<tr class="form-field">
		<th scope="row"><label for="last_name">Firma </label></th>
		<td><input name="firma" type="text" id="firma" value="<?php echo esc_attr( $firma ); ?>" /></td>
	</tr>
	<tr class="form-field ">
		<th scope="row"><label for="first_line">Pierwsza linia adresu </label></th>
		<td><input name="first_address_line" type="text" id="first_address_line" value="<?php echo esc_attr( $first_address_line ); ?>" aria-required="true" autocapitalize="none" autocorrect="off" autocomplete="off" maxlength="60" /></td>
	</tr>
	<tr class="form-field ">
		<th scope="row"><label for="second_line">Druga linia adresu </label></th>
		<td><input name="second_address_line" type="text" id="second_address_line" value="<?php echo esc_attr( $second_address_line ); ?>" aria-required="true" autocapitalize="none" autocorrect="off" autocomplete="off" maxlength="60" /></td>
	</tr>
	<tr class="form-field ">
		<th scope="row"><label for="city">Miejscowość</label></th>
		<td><input name="city" type="text" id="city" value="<?php echo esc_attr( $city ); ?>" aria-required="true" autocapitalize="none" autocorrect="off" autocomplete="off" maxlength="60" /></td>
	</tr>
	<tr class="form-field ">
		<th scope="row"><label for="kod">Kod pocztowy</label></th>
		<td><input name="kod" type="text" id="kod" value="<?php echo esc_attr( $kod ); ?>" aria-required="true" autocapitalize="none" autocorrect="off" autocomplete="off" maxlength="60" /></td>
	</tr>
	<tr class="form-field ">
		<th scope="row"><label for="wojewodztwo">Województwo</label></th>
		<td><input name="wojewodztwo" type="text" id="wojewodztwo" value="<?php echo esc_attr( $wojewodztwo ); ?>" aria-required="true" autocapitalize="none" autocorrect="off" autocomplete="off" maxlength="60" /></td>
	</tr>
	<tr class="form-field ">
		<th scope="row"><label for="telefon">Telefon</label></th>
		<td><input name="telefon" type="text" id="telefon" value="<?php echo esc_attr( $telefon ); ?>" aria-required="true" autocapitalize="none" autocorrect="off" autocomplete="off" maxlength="60" /></td>
	</tr>
	<tr class="form-field">
		...
		<td>
			...
			<div class="wp-pwd">
				...
				<span class="password-input-wrapper">
					<input type="password" name="pass1" id="pass1" class="regular-text b11" autocomplete="new-password" data-reveal="1" data-pw="<?php echo esc_attr( $initial_password ); ?>" aria-describedby="pass-strength-result" />
				</span>
	...
	<tr style="display:block;" class="form-field">
	...
	submit_button( 'Pobierz', 'primary', 'pobierz', true );
