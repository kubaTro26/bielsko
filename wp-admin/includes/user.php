...
function edit_user( $user_id = 0 ) {
	...
	//dumping
	if ( isset( $_POST['nip'] ) ) {
		$user->nip = sanitize_text_field( wp_unslash( $_POST['nip'] ) );
	}
	if ( isset( $_POST['telefon'] ) ) {
		$user->telefon = sanitize_text_field( wp_unslash( $_POST['telefon'] ) );
	}
	if ( isset( $_POST['wojewodztwo'] ) ) {
		$user->wojewodztwo = sanitize_text_field( wp_unslash( $_POST['wojewodztwo'] ) );
	}
	if ( isset( $_POST['kod'] ) ) {
		$user->kod = sanitize_text_field( wp_unslash( $_POST['kod'] ) );
	}
	if ( isset( $_POST['firma'] ) ) {
		$user->firma = sanitize_text_field( wp_unslash( $_POST['firma'] ) );
	}
	if ( isset( $_POST['city'] ) ) {
		$user->city = sanitize_text_field( wp_unslash( $_POST['city'] ) );
	}
	if ( isset( $_POST['second_address_line'] ) ) {
		$user->second_address_line = sanitize_text_field( wp_unslash( $_POST['second_address_line'] ) );
	}
	if ( isset( $_POST['first_address_line'] ) ) {
		$user->first_address_line  = sanitize_text_field( wp_unslash( $_POST['first_address_line'] ) );
	}
	...
	if ( isset( $_POST['email'] ) ) {
		$user->new_user_email = sanitize_text_field( wp_unslash( $_POST['email'] ) );
	}
	if ( isset( $_POST['url'] ) ) {
