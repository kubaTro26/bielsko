	...
	default:
		...
		<div class="wrap" id="profile-page">
			...
			<form id="your-profile" action="<?php echo esc_url( self_admin_url( IS_PROFILE_PAGE ? 'profile.php' : 'user-edit.php' ) ); ?>" method="post" novalidate="novalidate"
				...
				<table class="form-table" role="presentation a2">
					<tr class="user-user-login-wrap">
						<th><label for="user_login"><?php _e( 'Username' ); ?></label></th>
						<td><input type="text" name="user_login" id="user_login" value="<?php echo esc_attr( $profile_user->user_login ); ?>" disabled="disabled" class="regular-text b4" /> <span class="description"><?php _e( 'Usernames cannot be changed.' ); ?></span></td>
					</tr>
					...
					<tr style="display:none;" class="user-display-name-wrap">
						<th>
				...
				<table class="form-table" role="presentation a3">
					...
					<tr class="user-<?php echo $name; ?>-wrap">
						...
						<td>
							<input type="text" name="<?php echo $name; ?>" id="<?php echo $name; ?>" value="<?php echo esc_attr( $profile_user->$name ); ?>" class="regular-text b8" />
						</td>
					</tr>
					<?php endforeach; ?>
				</table>
				...
				<table style="display:none;" class="form-table" role="presentation a4">
					...
					<?php if ( $show_password_fields ) : ?>
						...
						<table  style="display:none;" class="form-table" role="presentation a5">
								...
								<td>
									...
									<div class="wp-pwd hide-if-js">
										<span class="password-input-wrapper">
											<input type="password" name="pass1" id="pass1" class="regular-text b9" value="" autocomplete="new-password" data-pw="<?php echo esc_attr( wp_generate_password( 24 ) ); ?>" aria-describedby="pass-strength-result" />
										</span>
							...
							<tr class="user-pass2-wrap hide-if-js">
								...
								<td>
								<input name="pass2" type="password" id="pass2" class="regular-text b10" value="" autocomplete="new-password" aria-describedby="pass2-desc" />
									<?php if ( IS_PROFILE_PAGE ) : ?>
					...
					<?php if ( wp_is_application_passwords_available_for_user( $user_id ) || ! wp_is_application_passwords_supported() ) : ?>
						<div style="display:none;" class="application-passwords hide-if-no-js" id="application-passwords-section">
							<h2 style="display:none;" ><?php _e( 'Application Passwords' ); ?></h2>
