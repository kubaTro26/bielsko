...
<?php } ?>
	...
	<table class="form-table" role="presentation">
		<tr class="form-field form-required">
			...
			<td><input type="text" class="regular-text b18" name="user[username]" id="username" autocapitalize="none" autocorrect="off" maxlength="60" /></td>
		</tr>
		<tr class="form-field form-required">
			<th scope="row"><label for="email"><?php _e( 'Email' ); ?></label></th>
			<td><input type="email" class="regular-text b19" name="user[email]" id="email" /></td>
		</tr>
		<tr class="form-field">
