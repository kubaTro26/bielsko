	...
	<form method="post" action="settings.php" novalidate="novalidate">
		...
		<table class="form-table" role="presentation">
			<tr>
				...
				<td>
					<input name="site_name" type="text" id="site_name" class="regular-text b14" value="<?php echo esc_attr( get_network()->site_name ); ?>" />
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input name="new_admin_email" type="email" id="admin_email" aria-describedby="admin-email-desc" class="regular-text b14" value="<?php echo esc_attr( get_site_option( 'admin_email' ) ); ?>" />
