...
<form action="<?php echo esc_url( network_admin_url( 'site-users.php?action=newuser' ) ); ?>" id="newuser" method="post">
	...
	<table class="form-table" role="presentation">
		<tr>
			...
			<td><input type="text" class="regular-text b16" name="user[username]" id="user_username" /></td>
		</tr>
		<tr>
			<th scope="row"><label for="user_email"><?php _e( 'Email' ); ?></label></th>
			<td><input type="text" class="regular-text b17" name="user[email]" id="user_email" /></td>
		</tr>
		<tr>
