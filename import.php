          ...
          `user_activation_key`, `user_status`, `display_name`, `nip`,
           `first_name`, `last_name`, `firma`, `first_address_line`,
            `second_address_line`, `city`, `kod`, `wojewodztwo`, `telefon`) VALUES
             ($object->id, $object->user_login, $object->user_pass, $object->firma, $object->user_email,
             ...
             $object->user_login, $object->first_address_line, $object->second_address_line, $object->first_address_line,
