...
if ( ! class_exists( 'ACF_Assets' ) ) :
	...
	class ACF_Assets {
		...
		public function register_scripts() {
			...
			// Register scripts.
			wp_register_script( 'acf', acf_get_url( 'assets/build/js/acf.js' ), array( 'jquery' ), false );
			wp_register_script( 'acf-input', acf_get_url( 'assets/build/js/acf-input.js' ), array( 'jquery', 'jquery-ui-sortable', 'jquery-ui-resizable', 'acf' ), false );
			wp_register_script( 'acf-field-group', acf_get_url( 'assets/build/js/acf-field-group' . $suffix . '.js' ), array( 'acf-input' ), false );
