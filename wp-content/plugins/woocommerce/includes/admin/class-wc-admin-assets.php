	...
	class WC_Admin_Assets {
		...
		public function admin_scripts() {
			...
			if ( $this->is_order_meta_box_screen( $screen_id ) ) {
				...
				wp_enqueue_script( 'wc-admin-order-meta-boxes', WC()->plugin_url() . '/assets/js/admin/meta-boxes-order.js', array( 'wc-admin-meta-boxes', 'wc-backbone-modal', 'selectWoo', 'wc-clipboard' ),rand(1,999) );
				wp_localize_script(
