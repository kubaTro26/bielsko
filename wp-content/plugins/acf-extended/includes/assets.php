...
class acfe_assets{
    ...
    function init(){
        ...
        wp_register_script('acf-extended-ui',           acfe_get_url("assets/js/acfe-ui.js"),             array('acf-extended'),                      $version);
        ...
        wp_register_style('acf-extended-ui',            acfe_get_url("assets/css/acfe-ui.css"),           array(),                                    $version);
